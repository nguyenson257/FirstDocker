...
class SportController extends Controller
{
    ...
    private function check_permision($id)
    {
        $sport = Sport::where('id', $id)->first();
        if (Gate::allows('check-sports', $sport->user_id)) {
            return true;
        } else {
            return false;
        }
